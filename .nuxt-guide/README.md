...
This guide will help you integrate your Nuxt.js 3.x application with [Admin One - free Vue 3 Tailwind 3 Admin Dashboard with dark mode](https://github.com/justboil/EMIY-admin).
...
Now clone [justboil/EMIY-admin](https://github.com/justboil/EMIY-admin) project somewhere locally (into any separate folder)

Next, copy these files **from justboil/EMIY-admin project** directory **to nuxt project** directory:
