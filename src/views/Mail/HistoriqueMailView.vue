                        ...
                        <div class="col-lg-12 col-md-12 col-xl-12 col-sm-12">
                            ...
                            <div class="card ps-3 pe-3 mb-lg-0 mb-4 ">
                                <div class="row p-2  pb-2 border-bottom">
                                    <div class="col">
                                        <div class="d-flex  justify-content-between">
                                            <h4 class="mb-1 ml-0 mt-2 font-weight-bolder  text-mobile text-dark">Liste de vos mails
                                            </h4>
                                        </div>
                                    ...
                                    <div class="col-3 mt-3" align="right">
                                        <input class="form-control" v-model='search' @input="searchFunction"
                                            v-if="!statusMail" placeholder="search" type="search" />
                                ...
                                <div v-if="!statusMail">
                                    <div class="table-responsive trx mt-1">
                                        ...
                                        <table class="table  " v-else>
                                            ...
                                            <div class="  d-flex justify-content-center pb-3"
                                                v-if="listMail.length == 0">

                                                Vide

                                            </div>
                                            <tbody>
                                                <tr v-for="(mail, index)  in listMail"
                                                    v-show="start <= index && index < final" :key="mail.message"
                                                    class="mouse"
                                                    ...
                                                    <td class="mobile">
                                                        <div class="text-left  col2 message">
                                                            <p class="mb-0 text-xs ">addresse Emetteur :</p>
                                                            <h6 class="mb-0 text-sm message font-weight-bold text-dark">
                                                                {{
                                                                        mail.addresseEmetteur
                                                                }}</h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-left  col2 message">
                                                            <p class="mb-0 text-xs ">addresse Recepteur :</p>
                                                            <h6 class="mb-0 text-sm message font-weight-bold text-dark">
                                                                {{
                                                                        mail.addresseRecepteur
                                                                }}</h6>
                                                        </div>
                                                    </td>
                                                    <!--  <td class=" ">
                                                    ...
                                                    <td class='mobile'>
                                                        <div class="text-left">
                                                            <p class="mb-0 text-xs ">Date envoi</p>
                                    ...
                                    <div class='card-footer' v-if='(listMail.length > 10)' align='right'>
                                        <div class="row   col-lg-1 col-md-4 col-xl-5 col-sm-5"
                                            ...
                                            <div class="  mouseY">
                                                <i @click="next" v-if='(final < listMail.length)'
                                ...
                                <!--   <div v-else>
                                    ...
                                    <CustomButton :title='" Envoyer"' :loading='loading'
                                        @update:loading="loading = $event" @click='newReponse'
...
export default {
    ...
    setup() {
        ...
        async function getmail() {
            ...
            const response = await new RequestApi().getlistMail();
            if (response.status) {
