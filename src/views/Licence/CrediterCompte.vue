    ...
    <div class=" row">
      <div class="col-12">
        <div class="card w-100 mb-4">
          <div class="card-body">
            <div class="part1">
              <h4 class="card-title font-weight-bolder dark text-mobile">Approvisionnez un compte</h4>
              <p class="card-text border-bottom text-mobile2 ">Crediter le compte d'un client.</p>
              <div class="row">
...
" />
        ...
        <div class="card w-100 mb-10" v-show="serviceSelect.id == 1">
          <div class="card-body">
            <div class="part1">
              ...
              <p class="card-text border-bottom text-mobile2 ">Renseignez la quantite de SMS et le pays.</p>
              <div class="row">
                <!--   <div class="col-lg-4 col-sm-12 form-group  ">
        ...
        <div class="card w-100 mb-10" v-show="serviceSelect.id == 2">
          <div class="card-body">
            <div class="part1">
              <h4 class="card-title font-weight-bolder dark text-mobile">Completez la procedure</h4>
              <p class="card-text border-bottom text-mobile2 ">Renseignez le montant a transferer.</p>
              <div class="row">
    ...
    <vue-final-modal v-model="achat" style="" classes="modal-container-paiement   "
      ...
      <p class="card-text border-bottom text-mobile2 ">Crediter le compte d'un client.</p>
      <h6 class="card-title font-weight-bolder dark text-mobile">Envoie de {{ montant }} {{ (serviceSelect.id == 1) ?
          "sms" :
          "credit"
      }}<!--  au compte de
        {{ beneficiaireSelect.label }} -->
      </h6>
...
export default {
  ...
  setup() {
    ...
    const transfert = async () => {
      ...
      // console.log(paysR.value.id, licence.value.id);

      // if (paysR.value.id == licence.value.id) {
