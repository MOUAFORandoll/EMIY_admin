  ...
  <nav class="navbar navbar-expand-lg top-0 z-index-3 position-absolute mt-4"
    ...
    <div class="container ps-2 pe-0">
      <router-link class="navbar-brand font-weight-bolder ms-lg-0 ms-3" :class="darkMode ? 'text-black' : 'text-white'"
        to="/"><img src='../../assets/img/logos/devoo.svg' style="   height: 100px; width: 50px;"
          class="navbar-brand-img h-100" alt="main_logo" /></router-link>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <router-link class="nav-link me-2" to="/price">
              <i class="fas fa-key opacity-6 me-1" aria-hidden="true" :class="isBlur ? 'text-dark' : 'text-white'"></i>
              Price
            </router-link>
          </li>
          <!--   <li class="nav-item">
            <router-link class="nav-link me-2" to="/prix">
              <i class="fas fa-key opacity-6 me-1" aria-hidden="true" :class="isBlur ? 'text-dark' : 'text-white'"></i>
              Prix
            </router-link>
          </li> -->
        ...
        <ul class="navbar-nav ">
          <li class="nav-item">
            <a href="https://pubx.cm" class="btn btn-sm mb-0 me-1" :class="isBtn">Découvrez PubX</a>
          </li>
        </ul>
      </div>
    </div>
